...
# ======================================================================
"""
The `pyxa.utils.options` module provides interactive UI on cmd.

These are the utilities for interacting with cmd using questionary.
"""
...
def answer(question: str) -> Optional[str]:
  ...
  while True:
    ...
    if revert == '':
      option = confirm('No inputs received. Would you like to try that again?')
